...
const summary = [
  {
    label: "Engagement",
    value:
      "Fixed-fee build of the LandGear Phase 1 MVP for Mountain Property — a working, production-grade land feasibility platform.",
  },
  {
    label: "Duration",
  ...
  },
  {
    ...
    value:
      "One product owner + ~2 hrs / week review. LandGear handles everything else end-to-end.",
  },
];

const why = [
  "AI-accelerated build — 3 months of focused output at a fraction of a traditional in-house rebuild.",
  "Domain-owned team — the engineers behind the national LandGear research, now building for you.",
  ...
  return (
    <div className="w-full h-full bg-white p-[42px] flex flex-col">
      ...
      <p className="font-body text-[10px] text-[#85979B] leading-[1.7] mt-4 max-w-[440px]">
        ...
        commercial terms for LandGear to design, build, and hand over the
