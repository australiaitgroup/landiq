...
const steps = [
  ...
  },
  {
    ...
    desc: "LandQ hits government APIs in real-time — zoning, FSR, height, heritage, flood, bushfire.",
  },
  {
    icon: FileText,
    num: "03",
...
const advantages = [
  ...
  },
  {
    ...
    desc: "From $50–250K per project to ~$5K with LandQ.",
  },
];
          ...
          {menuOpen && (
            ...
            >
              <div className="px-6 py-4 space-y-1 border-t border-surface-300">
                {["How It Works", "Platform", "Why LandQ"].map((t) => (
                  <a
                    key={t}
            ...
            <div className="md:col-span-5">
              <FadeIn>
                ...
                <p className="font-body text-[17px] leading-[1.7] text-surface-500 mb-8">
                  ...
                  consultant reports, spreadsheet models. LandQ replaces it all
            ...
            <div className="md:col-span-5 order-2 md:order-1">
              <FadeIn>
                <div className="rounded-xl overflow-hidden">
                  <img
                    src="/landq-ai-brand/images/aerial/aerial-development-03.jpg"
      ...
      <footer className="bg-primary-900 border-t border-white/[0.06]">
        <div className="mx-auto max-w-[1400px] px-6 md:px-16 py-16">
          <div className="grid md:grid-cols-3 gap-12 mb-14">
            <div>
              <h3 className="font-serif text-2xl text-white mb-3">LandQ</h3>
