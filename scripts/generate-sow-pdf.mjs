...
const outputPath = path.join(__dirname, "..", "public", "LandGear-SOW.pdf");

const TOTAL_PAGES = 10;

async function generateSowPDF() {
  ...
  await page.goto("http://localhost:3456/landiq/sow", {
