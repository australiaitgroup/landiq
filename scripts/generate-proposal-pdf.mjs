...
async function generateProposalPDF() {
  ...
  await page.goto("http://localhost:3456/landq-ai-brand/proposal", {
  ...
  for (let i = 0; i < TOTAL_PAGES; i++) {
    ...
    if (i > 0) {
      // Match the "Next →" arrow button specifically — NOT the "Next Steps"
      // dot-navigator button which also contains "Next" in its label.
      await page.evaluate(() => {
