...
const outputPath = path.join(
  ...
  "..",
  "public",
  "LandQ-Tech-Solution.pdf"
);

const TOTAL_PAGES = 10;

async function generateTechSolutionPDF() {
  ...
  await page.goto("http://localhost:3456/landq-ai-brand/tech-solution", {
...
generateTechSolutionPDF().catch((err) => {
